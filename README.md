...
<li>On the resource group select create new and create a new resource group called AIGaming</li>
<li>Tick I agree to the terms and conditions stated above check box </li>
<li>Finally select purchase.</li>
